...
static const std::map<std::string,Instruction*> instructionByName = {
            ...
            { std::string("add"), (new Instruction("add"))->setExecutionFunction(&Executor::_add)->setOverloadedRegisterCount(2)->setSupposedIntegerCount(0)},
            { std::string("addi"), (new Instruction("addi"))->setExecutionFunction(&Executor::_addi) },
            { std::string("sub"), (new Instruction("sub"))->setExecutionFunction(&Executor::_sub)->setOverloadedRegisterCount(2)->setSupposedIntegerCount(0)},
            ...
            { std::string("addu"), (new Instruction("addu"))->setExecutionFunction(&Executor::_addu)->setOverloadedRegisterCount(2)->setSupposedIntegerCount(0)},
            { std::string("subu"), (new Instruction("subu"))->setExecutionFunction(&Executor::_subu)->setOverloadedRegisterCount(2)->setSupposedIntegerCount(0)},
